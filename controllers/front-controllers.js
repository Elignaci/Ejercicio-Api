...
/**Al igual que con index las funciones que reciben el requerimiento tanto de servicios como productos establece la ruta donde se va a visualizar la pagina
 * @param {Object} req devuelve el request de la variable de  
 * @param {Object} res devuelve la respuesta 
 * @returns {return} retorna el status del error 
 */
 ...
 * @returns nos devuelve el estado de la respuesta
 * Mediante una condicion indicamos que si servicioEliminado existe (200) sera eliminado 
 */
